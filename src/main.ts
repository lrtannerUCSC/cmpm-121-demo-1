...
interface Item {
  ...
  const availableItems: Item[] = [
    { name: "Drill Manager", cost: 10, rate: 0.1, description: "Automates basic drilling operations to increase output and reduce manpower." },
    { name: "Price Stabilizer", cost: 100, rate: 2, description: "Employs economic tactics to manage and influence oil prices subtly within the market." },
    { name: "Regulatory Loophole", cost: 300, rate: 10, description: "Exploits legal gray areas to bypass regulations and maximize extraction rates." },
    { name: "Cartel Collaborator", cost: 1000, rate: 50, description: "Forms influential and shadowy alliances with major players to control market movements and suppress competition." },
    { name: "Bribery", cost: 5000, rate: 500, description: "Ensures favorable legislation and market conditions through strategic distribution of resources to key figures." },
  ];
